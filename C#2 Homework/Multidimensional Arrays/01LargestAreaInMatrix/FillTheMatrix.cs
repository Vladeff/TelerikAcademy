...
class FillTheMatrix
{
    static void Main()
    {
        ...
        Console.Write("Select type of filling to fill the matrix (a, b, c or d): ");
        char type = char.Parse(Console.ReadLine());

        int[,] matrix = new int[n, n];
        switch (type)
        {
            case 'a': typeA(matrix); break;
            case 'b': typeB(matrix); break;
            case 'c': typeC(matrix); break;
            case 'd': typeD(matrix); break;

        }
        PrintingMatrix(matrix);
    }

    private static void typeD(int[,] matrix)
    {
        throw new NotImplementedException();
    }

    private static void typeC(int[,] matrix)
    {
        throw new NotImplementedException();
    }

    private static void typeB(int[,] matrix)
    {
        throw new NotImplementedException();
    }

    private static void typeA(int[,] matrix)
    {
        throw new NotImplementedException();
    }
